...
public class ThermalReceiverGuard implements Listener {
    @EventHandler
    public void onEntityInteract(PlayerInteractAtEntityEvent e) {
        if (!ThermalReceivers.getInstance().isDecorate(e.getRightClicked())) return;
    ...
    public void onEntityDamages(EntityDamageEvent e) {
        if (!ThermalReceivers.getInstance().isDecorate(e.getEntity())) return;
